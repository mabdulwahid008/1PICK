...
ALTER TABLE EVENTS ADD can_be_reported BOOLEAN DEFAULT TRUE
ALTER TABLE EVENTS ADD can_be_appealed BOOLEAN DEFAULT TRUE

ALTER TABLE NUMBERS ADD per_day_event_creation INT DEFAULT 5
